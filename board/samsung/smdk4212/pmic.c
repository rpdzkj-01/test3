...
void pmic_init1(void )
{
	unsigned int value=0,kk=0;

	value=*((volatile unsigned int *)0x11000C60);
	value &= ~(0x1 << 12);
	value |= (0x1 << 12);
	*((volatile unsigned int *)0x11000C60) = value;
	value=*((volatile unsigned int *)0x11000C64);
	value |=(0x1<<3);
	*((volatile unsigned int *)0x11000C64) = value;
