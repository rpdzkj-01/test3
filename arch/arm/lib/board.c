...
{
	gd->bd->bi_dram[0].start = CONFIG_SYS_SDRAM_BASE; //0x40000000
...
void board_init_f (ulong bootflag)
{
	...
	gd = (gd_t *) ((CONFIG_SYS_INIT_SP_ADDR) & ~0x07);  //0x42e00000
	...
	addr = CONFIG_SYS_SDRAM_BASE + gd->ram_size;//0x40000000
